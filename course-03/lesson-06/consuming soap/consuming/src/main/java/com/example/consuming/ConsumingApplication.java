...
public class ConsumingApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		//create and setup jaxb marshaller
		//serialize and deserialize XML requests to and from Java:
		Jaxb2Marshaller marshaller = new Jaxb2Marshaller();

		//provide location to the Object Factory
		// ObjectFactory was provided when generating code from wsdl:
